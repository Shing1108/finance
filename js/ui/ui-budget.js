...
function initializeBudgetsTab(budgetsTab) {
    ...
    // 1. 預算設置卡片
    const settingsCard = createBudgetSettingsCard();
    container.appendChild(settingsCard);
    
    // 2. 預算進度卡片
    const progressCard = createBudgetProgressCard();
    container.appendChild(progressCard);
    
    // 3. 月度預算設置卡片
    const monthlyBudgetCard = createMonthlyBudgetCard();
    container.appendChild(monthlyBudgetCard);
    
    // 4. 類別預算卡片
    const categoryBudgetCard = createCategoryBudgetCard();
 ...
 * 創建預算設置卡片
 */
function createBudgetSettingsCard() {
 ...
 * 創建預算進度卡片
 */
function createBudgetProgressCard() {
 ...
 * 創建月度預算卡片
 */
function createMonthlyBudgetCard() {
 ...
 * 創建類別預算卡片
 */
function createCategoryBudgetCard() {
